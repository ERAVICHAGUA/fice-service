...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("https://devioz-frontend-777439108015.us-central1.run.app", "http://localhost:5173", "http://127.0.0.1:5173"));
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                // ESTO ES CLAVE: No guardar estado de sesión
